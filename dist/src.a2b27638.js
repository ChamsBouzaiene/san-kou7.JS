...
},{"./bg.png":[["bg.cd2b7aec.png","src/style/bg.png"],"src/style/bg.png"],"./sun.gif":[["sun.8a01f27a.gif","src/style/sun.gif"],"src/style/sun.gif"],"./lava-5.png":[["lava-5.6562e1f5.png","src/style/lava-5.png"],"src/style/lava-5.png"],"./tile-2.png":[["tile-2.54aa889e.png","src/style/tile-2.png"],"src/style/tile-2.png"],"./fitted-coins.png":[["fitted-coins.735a9403.png","src/style/fitted-coins.png"],"src/style/fitted-coins.png"],"./left.png":[["left.13b2cb78.png","src/style/left.png"],"src/style/left.png"],"./jumpLeft.png":[["jumpLeft.ae5ef804.png","src/style/jumpLeft.png"],"src/style/jumpLeft.png"],"./jump.png":[["jump.0bce018e.png","src/style/jump.png"],"src/style/jump.png"],"./right.png":[["right.78f71526.png","src/style/right.png"],"src/style/right.png"],"./newSprite.png":[["newSprite.137c35f6.png","src/style/newSprite.png"],"src/style/newSprite.png"],"_css_loader":"../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/css-loader.js"}],"src/lib/Vector.js":[function(require,module,exports) {
"use strict";
...
/*#__PURE__*/
function () {
  function State(level, actors, status, menu) {
  ...
  _createClass(State, [{
    ...
    key: "start",
    value: function start(level, menu) {
...
State.prototype.update = function (time, keys) {
  ...
  var status = State.nextStatus(this.status, keys);
  var menu = this.menu.update(this, keys);
  console.log(menu, "new MEnu");
  var newState = new State(this.level, actors, status, menu);
...
Coin.prototype.collide = function (state) {
  ...
  return new _State.default(state.level, filtered, status);
};
...
exports.levelChars = exports.groundLevel = exports.groundLevel2 = void 0;
...
var _default = Level;
exports.default = _default;
},{"./Vector":"src/lib/Vector.js","../data/levels":"src/data/levels.js"}],"src/lib/Menu.js":[function(require,module,exports) {
"use strict";
...
},{}],"src/renderEngine/listeners.js":[function(require,module,exports) {
"use strict";
...
var arrowKeys = trackKeys(["ArrowLeft", "ArrowRight", "ArrowUp", "Escape"]);
...
function updateLava(nodes, state) {
  var lavaNode = nodes.getElementsByClassName("lava")[0];
...
function updateActors(actorLayer, state) {
  ...
  updateCoin(actorLayer, state); // updateLava();
...
function runLevel(level, dis, men) {
  var menu = men;
  var display = dis;
...
function runLevel(level, Display) {
  ...
  var state = _State.default.start(level);
...
},{"../lib/State":"src/lib/State.js","../lib/Menu":"src/lib/Menu.js","./listeners":"src/renderEngine/listeners.js"}],"node_modules/regenerator-runtime/runtime.js":[function(require,module,exports) {
var global = arguments[3];
/**
...
var runGame = function () {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(plans, Display, Menu) {
    var status;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _lib.runLevel)(plans, Display, Menu);
          ...
          case 9:
            ...
            return _context.abrupt("return", console.log("You've won!"));
  ...
  return function runGame(_x, _x2, _x3) {
    return _ref.apply(this, arguments);
  };
}();

exports.runGame = runGame;
},{"../lib/Level":"src/lib/Level.js","./lib":"src/renderEngine/lib.js","regenerator-runtime/runtime":"node_modules/regenerator-runtime/runtime.js"}],"src/renderEngine/DomDisplay.js":[function(require,module,exports) {
"use strict";
...
var menu = new _Menu.default("off");
(0, _renderEngine.runGame)(simpleLevel, display, menu);
},{"babel-core/register":"node_modules/babel-core/register.js","babel-polyfill":"node_modules/babel-polyfill/lib/index.js","./style/main.css":"src/style/main.css","./renderEngine":"src/renderEngine/index.js","./lib/Menu":"src/lib/Menu.js","./lib/Level":"src/lib/Level.js","./data/levels":"src/data/levels.js","./renderEngine/DomDisplay":"src/renderEngine/DomDisplay.js"}],"../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
